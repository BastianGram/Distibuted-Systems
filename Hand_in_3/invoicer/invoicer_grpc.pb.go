...
type ChittyChatClient interface {
	...
	BroadcastMessage(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[BroadcastRequest, BroadcastResponse], error)
}
...
func (c *chittyChatClient) BroadcastMessage(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[BroadcastRequest, BroadcastResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChittyChat_BroadcastMessageClient = grpc.BidiStreamingClient[BroadcastRequest, BroadcastResponse]
...
type ChittyChatServer interface {
	...
	// Server will broadcast messages (including join/leave) to all clients
	BroadcastMessage(grpc.BidiStreamingServer[BroadcastRequest, BroadcastResponse]) error
...
func (UnimplementedChittyChatServer) BroadcastMessage(grpc.BidiStreamingServer[BroadcastRequest, BroadcastResponse]) error {
...
func _ChittyChat_BroadcastMessage_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ChittyChatServer).BroadcastMessage(&grpc.GenericServerStream[BroadcastRequest, BroadcastResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChittyChat_BroadcastMessageServer = grpc.BidiStreamingServer[BroadcastRequest, BroadcastResponse]
